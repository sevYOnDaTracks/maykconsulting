...
class __TwigTemplate_1753ca2a92de59e116c02c66ad191239 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        yield "<nav class=\"navbar navbar-light navbar-expand-md sticky-top navbar-shrink py-3\" style=\"max-width: 100%; height: auto;\" id=\"mainNav\">
\t<div class=\"container\">
...
\t\t\t\t<img src=\"";
        ...
        yield "\" alt=\"Logo\" width=\"128\" height=\"128\" style=\"max-width: 100%; height: auto;\">
\t\t\t</span>
...
\t\t\t";
        ...
        if ( !CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 36, $this->source); })()), "user", [], "any", false, false, false, 36)) {
            // line 37
            yield "\t\t\t\t<a class=\"btn btn-dark btn-sm shadow\" href=\"";
...
\t\t\t";
            ...
            // line 44
            yield "\t\t\t\t<a class=\"btn btn-danger btn-sm shadow\" href=\"/logout\">Déconnexion</a>
\t\t\t";
        }
        // line 46
        yield "\t\t</div>
...
";
    ...
    {
        return array (  116 => 46,  112 => 44,  101 => 37,  99 => 36,  96 => 35,  90 => 32,  86 => 30,  83 => 29,  77 => 25,  75 => 24,  64 => 16,  50 => 5,  44 => 1,);
    }
