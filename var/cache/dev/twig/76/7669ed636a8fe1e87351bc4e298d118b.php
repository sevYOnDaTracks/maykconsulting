...
class __TwigTemplate_ff27fe6eb41c4df1e8c55d0cd5e347fe extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container\">
    ...
    <table class=\"table\">
        ...
        if (((isset($context["pays"]) || array_key_exists("pays", $context) ? $context["pays"] : (function () { throw new RuntimeError('Variable "pays" does not exist.', 83, $this->source); })()) == "France")) {
            // line 84
            echo "                <td class=\"total-rouge\"> <strong> 150 000 FCFA (Taxe non comprise)</strong></td>
            ";
        }
        // line 86
        echo "            ";
        if (((isset($context["pays"]) || array_key_exists("pays", $context) ? $context["pays"] : (function () { throw new RuntimeError('Variable "pays" does not exist.', 86, $this->source); })()) == "Canada")) {
            // line 87
            echo "                <td class=\"total-rouge\"> <strong> 170 000 FCFA (Taxe non comprise)</strong></td>
            ";
        }
        // line 89
        echo "
