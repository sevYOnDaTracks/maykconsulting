...
class __TwigTemplate_5a7a2dd052c7e038fae019cca0719264 extends Template
{
    private $source;
    private $macros = [];
...
<body>
    ...
    <a href=\"";
        // line 9
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["signedUrl"]) || array_key_exists("signedUrl", $context) ? $context["signedUrl"] : (function () { throw new RuntimeError('Variable "signedUrl" does not exist.', 9, $this->source); })()), "html", null, true);
        yield "\">Confirmer mon adresse e-mail</a>
    <p>Ce lien expirera dans ";
        // line 10
        yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans((isset($context["expiresAtMessageKey"]) || array_key_exists("expiresAtMessageKey", $context) ? $context["expiresAtMessageKey"] : (function () { throw new RuntimeError('Variable "expiresAtMessageKey" does not exist.', 10, $this->source); })()), (isset($context["expiresAtMessageData"]) || array_key_exists("expiresAtMessageData", $context) ? $context["expiresAtMessageData"] : (function () { throw new RuntimeError('Variable "expiresAtMessageData" does not exist.', 10, $this->source); })()), "VerifyEmailBundle"), "html", null, true);
        yield ".</p>
    <p>Cordialement,</p>
