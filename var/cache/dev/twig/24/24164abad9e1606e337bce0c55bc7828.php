...
class __TwigTemplate_5485a29e5a4e60b37ca1c89e824576a5 extends Template
{
    private $source;
    private $macros = [];
...
<br><br>
        ...
        if (((isset($context["pays"]) || array_key_exists("pays", $context) ? $context["pays"] : (function () { throw new RuntimeError('Variable "pays" does not exist.', 83, $this->source); })()) == "France")) {
            // line 84
            yield "                    <td class=\"total-rouge\"> <strong> 350 000 FCFA (Taxe non comprise)</strong></td>
                ";
        }
        // line 86
        yield "                ";
        if (((isset($context["pays"]) || array_key_exists("pays", $context) ? $context["pays"] : (function () { throw new RuntimeError('Variable "pays" does not exist.', 86, $this->source); })()) == "Canada")) {
            // line 87
            yield "                    <td class=\"total-rouge\"> <strong> 500 000 FCFA (Taxe non comprise)</strong></td>
                ";
        }
        // line 89
        yield "
...
<br>
        ...
        // line 124
        yield Twig\Extension\EscaperExtension::escape($this->env, Twig\Extension\CoreExtension::dateFormatFilter($this->env, (isset($context["date_facture"]) || array_key_exists("date_facture", $context) ? $context["date_facture"] : (function () { throw new RuntimeError('Variable "date_facture" does not exist.', 124, $this->source); })()), "d/m/Y"), "html", null, true);
        yield "</p>
        <img align=\"right\" src=\"data:image/png;base64,";
        // line 125
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["image_content"]) || array_key_exists("image_content", $context) ? $context["image_content"] : (function () { throw new RuntimeError('Variable "image_content" does not exist.', 125, $this->source); })()), "html", null, true);
...
";
    ...
    {
        return array (  213 => 125,  209 => 124,  179 => 97,  175 => 96,  171 => 95,  163 => 89,  159 => 87,  156 => 86,  152 => 84,  150 => 83,  141 => 79,  134 => 75,  114 => 58,  107 => 54,  98 => 50,  51 => 6,  44 => 1,);
    }
